...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron text-center">
            <br>
            <h1>Thank you for trying out our demo!</h1>
            <h4>Please contact our sales team to get started.</h4>
            <br>
            <button type="button" class="btn btn-primary" onclick="document.location='contact.php'">Contact</button>
            <br>
        </div>
